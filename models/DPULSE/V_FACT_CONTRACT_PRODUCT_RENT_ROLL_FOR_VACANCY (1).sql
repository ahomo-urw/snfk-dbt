create or replace view EXPOSE_DEV.DPERFMGT.V_FACT_CONTRACT_PRODUCT_RENT_ROLL_FOR_VACANCY(
	PC_ID,
	PRODUCT_EXT_REF,
	CONTRACT_ID,
	BU_EXTREF,
...
comment= 'SGE202506: vacancy planit du rent roll pour reporting *PBI'
as
select 
 PC_ID,
 PRODUCT_EXT_REF,
