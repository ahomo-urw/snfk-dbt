create or replace view DPULSE.CRM_LEASINGORDER_W_KEY(
	LEASING_ORDER_ID,
	LEASING_ORDER_DESC,
	PC_CODE,
	...
	ISQFR
) COMMENT='AGAUDET: Created for external vizualisation tool and Plan-It Interface-aho modification 202505'
 as 
